...
class TransferedModel(Model):
    def _define_model(self, input_shape, categories_count):
        ...
        basic_model = models.load_model('path/to/basic_model.keras')
        
        # Freeze the weights of the loaded model
        for layer in basic_model.layers:
            layer.trainable = False
        
        # Remove the last layer and add new dense layers and an output layer
        self.model = Sequential()
        for layer in basic_model.layers[:-1]:
